...
st.set_page_config(
    layout="wide", page_title="Fondos & Modelos CAPM", page_icon="📈")
...
selected_tickers = st.sidebar.multiselect(
    "Selecciona fondos:", nyse_symbols, default=None,
)

if not selected_tickers:
    st.warning("Por favor, selecciona al menos un fondo.")
    st.stop()
...
# Obtener datos de precios de las fondos seleccionadas
...
with gb:
    ...
    for ticker in selected_tickers:
        ...
        if ticker in resultados:
            # Agregar una barra para el Beta de la fondo actual
            fig_betas.add_trace(
...
with ga:
    ...
    for ticker in selected_tickers:
        # Calcular los Alphas
        if ticker in resultados:
            # Agregar una barra para el Alpha de la fondo actual
